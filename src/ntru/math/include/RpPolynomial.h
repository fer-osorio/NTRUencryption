...
// Get and write.
enum ExceptionCode RpPolynomial_t_getCopyFromArray(const uint16_t* source, RpPolynomial_t* dest);
enum ExceptionCode RpPolynomial_t_writeCopyOnArray(ptrRpPolynomial_t source, uint16_t* dest);
